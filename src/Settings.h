...
struct Settings {
    ...
    // if true, enables minimal viewer mode (no context menu, same window
    // position, simplified toolbar)
    bool minimalViewer;
    // if true, show context menu on right click in the document canvas
    bool contextMenu;
    // if true, newly opened windows inherit the position and size of the
    // last active window
    bool newWindowSamePosition;
};
// for parsing themes
struct Themes {
    // color themes
...
static const FieldInfo gSettingsFields[] = {
    ...
    {offsetof(Settings, minimalViewer), SettingType::Bool, true},
    {offsetof(Settings, contextMenu), SettingType::Bool, false},
    {offsetof(Settings, newWindowSamePosition), SettingType::Bool, true},
    {offsetof(Settings, showMenubar), SettingType::Bool, false},
...
static const StructInfo gSettingsInfo = {
    ...
    "toreSession\0ReuseInstance\0MinimalViewer\0ContextMenu\0NewWindowSamePosition\0ShowMenubar\0ShowMenubarWithTabs\0S"
    "howPageNumberInTabs\0ShowHomePageReadingProgress\0ShowTips\0CustomColors\0ShowToolbar\0Toolbar\0ToolbarPosition\0S"
    "earchUIFloating\0ShowFavorites\0SortFavoritesByName\0ShowToc\0SidebarOnRight\0SidebarWindowSize\0ShowLinks\0Highli"
    "ghtFormFields\0ClickEdgeToTurnPage\0DisableLinks\0ExplorerQuickLook\0RememberViewOffsetOnPageTurn\0MouseWheelTurns"
    "Page\0ScrollEdgeTurnsPage\0ShowDocumentFocusIndicator\0ShowAnnotationNotification\0ShowFileNavigateHint\0ShowAnnot"
    "ationAuthorInTooltip\0ShowTocPageNumbers\0AutoGenerateTOC\0ShowStartPage\0SidebarDx\0Scrollbars\0ScrollbarInSingle"
    "Page\0SmoothScroll\0ScrollLineAmount\0SaveMemory\0PaddingAfterLastPage\0IgnoreDestinationZoom\0HighlightLinkDestin"
    "ation\0CitationHoverDelay\0ReadAloudVoiceId\0ReadAloudSpeed\0ReadingAutoScrollSpeed\0ReadingBar\0FastScrollOverScr"
    "ollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0LastLightTheme\0LastDarkTheme\0DocumentColorsFollowTheme\0TocDy"
    "\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSize\0TreeFontName\0TreeFontSize\0UIFontSize\0DisableAntiAlias"
    "\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0UseTabs\0SelectionToolbar\0SelectionToolbarLayout\0Ta"
    "bsMru\0CtrlTabSimple\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0ComicBookUI\0\0ImageUI\0\0ChmUI\0\0Ma"
    "rkdownUI\0\0HtmlUI\0\0ClaudeCode\0\0GrokBuild\0\0CodexBuild\0\0AntiGravity\0\0AIChatSidebarDx\0\0TranslateToLang\0"
    "TranslateFromLang\0TranslateEngine\0\0Annotations\0\0ExternalViewers\0\0ForwardSearch\0\0PrinterDefaults\0\0Fullsc"
    "reen\0\0SelectionHandlers\0\0Shortcuts\0\0Themes\0\0TabGroups\0\0CustomScreenDPI\0\0\0DefaultPasswords\0UiLanguage"
    ...
    "documents in the already running SumatraPDF instead of starting a new one\0if true, enables minimal viewer mode "
    "(no context menu, same window position, simplified toolbar)\0if true, show context menu on right click in the "
    "document canvas\0if true, newly opened windows inherit the position and size of the last active window\0if true, "
